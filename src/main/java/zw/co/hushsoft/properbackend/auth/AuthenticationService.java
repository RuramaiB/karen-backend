...
import zw.co.hushsoft.properbackend.config.JwtService;
import zw.co.hushsoft.properbackend.email.EmailSender;
import zw.co.hushsoft.properbackend.exception.ResourceNotFoundException;
import zw.co.hushsoft.properbackend.token.Token;
import zw.co.hushsoft.properbackend.token.TokenRepository;
import zw.co.hushsoft.properbackend.token.TokenState;
import zw.co.hushsoft.properbackend.token.TokenType;
...
import zw.co.hushsoft.properbackend.verification.VerificationRepository;
...
public class AuthenticationService {
        ...
        public String generateVerificationCode(String studentEmail) {
                ...
                // verificationRepository.delete(verificationRepository.findByEmail(studentEmail).orElseThrow(()->
        ...
        public AuthenticationResponse authenticateWithVerification(AuthenticationRequest request) {
                ...
                // code));
                // }catch (Exception e){
                // return AuthenticationResponse.builder().message("Verification request failed.
        ...
        private String buildEmail(String name, String verificationCode) {
                return "<div style=\"font-family:Helvetica,Arial,sans-serif;font-size:16px;margin:0;color:#0b0c0c\">\n"
                                ...
                                + verificationCode + "\">Activate Now</a> </p></blockquote>\n <p>See you soon</p>" +
                                "        \n" +
                                "      </td>\n" +
                                "      <td width=\"10\" valign=\"middle\"><br></td>\n" +
                                "    </tr>\n" +
